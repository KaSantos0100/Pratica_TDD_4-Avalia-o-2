...
class List_Contact_OK_Test(TestCase):
    def setUp(self):
        ...
        self.agenda = Agenda.objects.create(
            nome_completo='karina santos',
            telefone='1998563214',
            email='karina.teste@fatec.sp.gov.br',
            observacao='teste'
        )
        self.agenda2 = Agenda.objects.create(
            nome_completo='karina santos 2',
            telefone='1998563215',
            email='karina.teste2@fatec.sp.gov.br',
            observacao='teste 2'
        )
    ...
    def test_list_contacts(self): ##Esqueci de colocar test no nome :v
        ...
        self.assertEqual(response.status_code, HTTPStatus.OK)
        self.assertTemplateUsed(response, 'show_contact.html')
        self.assertContains(response, 'karina santos')
        self.assertContains(response, 'karina santos 2')
        self.assertContains(response, '1998563214')
        self.assertContains(response, '1998563215')
        self.assertContains(response, 'karina.teste@fatec.sp.gov.br')
        self.assertContains(response, 'karina.teste2@fatec.sp.gov.br')
    ...
    def test_list_contacts_empty(self):
        ...
        self.assertNotContains(response, 'karina santos')
        self.assertNotContains(response, 'karina santos 2')
        self.assertNotContains(response, '1998563214')
        self.assertNotContains(response, '1998563215')